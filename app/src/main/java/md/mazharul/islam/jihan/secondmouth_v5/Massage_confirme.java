...
public class Massage_confirme extends Activity implements ConnectionCallbacks,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_massage_confirme);
    ...
    class GetAddress extends AsyncTask<Double, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            try {
                ...
                //     String number = getIntent().getStringExtra("PERSON_NAME");

                SmsManager smsManager = SmsManager.getDefault();
                smsManager.sendTextMessage(( getIntent().getStringExtra("PERSON_NAME")), null, (myAddresFormat(Geocoding_suport.str1, Geocoding_suport.str2)), null, null);;
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pb = new ProgressDialog(Massage_confirme.this);
